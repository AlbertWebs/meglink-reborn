...
<section class="land-sale-section">
  <div class="container">
    <!-- Section Title -->
    <div class="row align-items-center mb-5">
      <div class="col-lg-8 col-md-8 wow fadeInLeft">
        ...
        <p class="wow fadeIn" data-wow-delay="0.8s" style="color:#000000">
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.{{ $loop->iteration }}s">
