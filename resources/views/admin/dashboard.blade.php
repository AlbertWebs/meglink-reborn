...
<div class="row">
    ...
    <!-- Renders -->
    <div class="col-lg-3 col-6 mb-4">
        <div class="small-box dashboard-card" style="background-color: #f37920; color: white;">
            <div class="inner">
                <h3>{{ $renderCount ?? 0 }}</h3>
                <p>Renders</p>
            </div>
    ...
    <!-- Hero Banner Slides -->
    <div class="col-lg-3 col-6 mb-4">
        <div class="small-box bg-gradient-dark text-white dashboard-card">
            <div class="inner">
                <h3>{{ $slideCount ?? 0 }}</h3>
    ...
    <!-- Team Members -->
    <div class="col-lg-3 col-6 mb-4">
        <div class="small-box bg-gradient-purple dashboard-card">
            <div class="inner">
                <h3>{{ $teamCount ?? 0 }}</h3>
                <p>Team Members</p>
            </div>
